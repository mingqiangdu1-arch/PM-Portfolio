...
from app.platform.mvp4_contract import install_mvp4_contract
from app.platform.mvp5_contract import install_mvp5_contract
...
def configure_openapi(app: FastAPI) -> None:
    def custom_openapi() -> dict:
        ...
        install_mvp4_contract(schema)
        install_mvp5_contract(schema)
